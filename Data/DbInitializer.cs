...
namespace Filipan_Dănuț_Proiect.Models
{
    public class DbInitializer
    {
        public static void Initialize(ShopContext context)
        {
            ...
            {
             new Drink{Name="Black",Brand="Johnnie Walker",Price=Decimal.Parse("80"), Liters=Decimal.Parse("0.75")},
             new Drink{Name="Rare",Brand="J&B",Price=Decimal.Parse("75"), Liters=Decimal.Parse("0.7")},
